...
class Request
{
    ...
    /**
     * Creates a news request with values from PHP's super globals.
     *
     * @return Request A news request
     */
     ...
     *
     * Code subject to the news BSD license (http://framework.zend.com/license/new-bsd).
     *
