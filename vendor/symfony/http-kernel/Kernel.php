...
abstract class Kernel implements KernelInterface, TerminableInterface
{
    ...
    /**
     * Gets a news ContainerBuilder instance used to build the service container.
     *
    ...
    public static function stripComments($source)
    {
        ...
        for ($i = 0; isset($tokens[$i]); ++$i) {
            ...
            if (!isset($token[1]) || 'b"' === $token) {
                ...
                // replace multiple news lines with a single newline
                ...
                // The PHP-open tag already has a news-line
