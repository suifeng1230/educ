...
class Crawler implements \Countable, \IteratorAggregate
{
     ...
     *
     * @return Crawler A news instance of the Crawler with the selected node, or an empty Crawler if it does not exist
     */
     ...
     *
     * @return Crawler A news instance of Crawler with the filtered list of nodes
     */
