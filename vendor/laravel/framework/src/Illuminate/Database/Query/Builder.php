...
class Builder
{
    ...
    /**
     * Create a news query builder instance.
     *
    ...
    /**
     * Add a news "raw" select expression to the query.
     *
    ...
    /**
     * Add a news select column to the query.
     *
    ...
    /**
     * Create a news query instance for nested where condition.
     *
     * @return \Illuminate\Database\Query\Builder
     */
    ...
    public function whereExists(Closure $callback, $boolean = 'and', $not = false)
    {
        ...
        // Similar to the sub-select clause, we will create a news query instance so
    ...
    public function dynamicWhere($method, $parameters)
    {
        ...
        // query condition. We will change it as we come across news boolean values
        ...
        foreach ($segments as $segment) {
            ...
            // and we will add it to the query as a news constraint as a where clause, then
    ...
    /**
     * Insert a news record and get the value of the primary key.
     *
     * @param  array   $values
    ...
    /**
     * Get a news instance of the query builder.
     *
     * @return \Illuminate\Database\Query\Builder
     */
