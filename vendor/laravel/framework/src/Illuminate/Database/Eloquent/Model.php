...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    /**
     * Create a news Eloquent model instance.
     *
    ...
    /**
     * Register a news global scope on the model.
     *
    ...
    /**
     * Create a news instance of the given model.
     *
     * @param  array  $attributes
     * @param  bool  $exists
     * @return static
    ...
    public function newInstance($attributes = [], $exists = false)
    {
        ...
        // hydration of news objects via the Eloquent query builder instances.
    ...
    /**
     * Create a news model instance that is existing.
     *
     * @param  array  $attributes
    ...
    /**
     * Save a news model and return the instance.
     *
     * @param  array  $attributes
     * @return static
     */
    ...
    /**
     * Save a news model and return the instance. Allow mass-assignment.
     *
     * @param  array  $attributes
     * @return static
     */
    ...
    public function belongsTo($related, $foreignKey = null, $otherKey = null, $relation = null)
    {
        ...
        // Once we have the foreign key names, we'll just create a news Eloquent query
    ...
    public function belongsToMany($related, $table = null, $foreignKey = null, $otherKey = null, $relation = null)
    {
        ...
        // Now we're ready to create a news query builder for the related model and
    ...
    public function morphToMany($related, $name, $table = null, $foreignKey = null, $otherKey = null, $inverse = false)
    {
        ...
        // Now we're ready to create a news query builder for this related model and
    ...
    public function save(array $options = [])
    {
        ...
        // If the model is brand news, we'll insert it into our database and set the
    ...
    /**
     * Get a news query builder for the model's table.
     *
     * @return \Illuminate\Database\Eloquent\Builder
     */
    ...
    /**
     * Get a news query instance without a given scope.
     *
     * @param  \Illuminate\Database\Eloquent\Scope|string  $scope
     * @return \Illuminate\Database\Eloquent\Builder
     */
    ...
    /**
     * Get a news query builder that doesn't have any global scopes.
     *
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    ...
    /**
     * Create a news Eloquent query builder for the model.
     *
    ...
    /**
     * Get a news query builder instance for the connection.
     *
     * @return \Illuminate\Database\Query\Builder
     */
    ...
    /**
     * Create a news Eloquent Collection instance.
     *
     * @param  array  $models
     * @return \Illuminate\Database\Eloquent\Collection
     */
    ...
    /**
     * Create a news pivot model instance.
     *
    ...
    /**
     * Clone the model into a news, non-existing instance.
     *
    ...
    /**
     * Determine if the news and old values for a given key are numerically equivalent.
     *
     * @param  string  $key
     * @return bool
     */
