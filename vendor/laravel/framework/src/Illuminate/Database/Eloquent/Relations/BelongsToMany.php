...
class BelongsToMany extends Relation
{
    ...
    /**
     * Create a news belongs to many relationship instance.
     *
    ...
    protected function hydratePivotRelation(array $models)
    {
        ...
        // and create a news Pivot model, which is basically a dynamic model that we
    ...
    /**
     * Save a news model and attach it to the parent model.
     *
     * @param  \Illuminate\Database\Eloquent\Model  $model
     * @param  array  $joining
     * @param  bool   $touch
    ...
    /**
     * Save an array of news models and attach them to the parent model.
     *
    ...
    /**
     * Find a related model by its primary key or return news instance of the related model.
     *
     * @param  mixed  $id
     * @param  array  $columns
    ...
    /**
     * Create a news instance of the related model.
     *
     * @param  array  $attributes
     * @param  array  $joining
     * @param  bool   $touch
    ...
    /**
     * Create an array of news instances of the related models.
     *
     * @param  array  $records
     * @param  array  $joinings
     * @return array
    ...
    public function sync($ids, $detaching = true)
    {
        ...
        // array of the news IDs given to the method which will complete the sync.
        ...
        // Now we are finally ready to attach the news records. Note that we'll disable
    ...
    protected function attachNew(array $records, array $current, $touch = true)
    {
        ...
        foreach ($records as $id => $attributes) {
            // If the ID is not in the list of existing pivot IDs, we will insert a news pivot
    ...
    protected function createAttachRecords($ids, array $attributes)
    {
        ...
        // and create a news record to insert for each ID. Each ID may actually be a
    ...
    /**
     * Create a news pivot attachment record.
     *
     * @param  int   $id
     * @param  bool  $timed
     * @return array
    ...
    /**
     * Create a news query builder for the pivot table.
     *
    ...
    /**
     * Get a news plain query builder for the pivot table.
     *
     * @return \Illuminate\Database\Query\Builder
     */
    ...
    /**
     * Get a news pivot statement for a given "other" ID.
     *
     * @param  mixed  $id
     * @return \Illuminate\Database\Query\Builder
     */
    ...
    /**
     * Create a news existing pivot model instance.
     *
     * @param  array  $attributes
     * @return \Illuminate\Database\Eloquent\Relations\Pivot
     */
