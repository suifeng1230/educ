...
class Collection implements ArrayAccess, Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    ...
    /**
     * Create a news collection instance if the value isn't one already.
     *
     * @param  mixed  $items
     * @return static
     */
    ...
    /**
     * Create a news collection consisting of every n-th element.
     *
     * @param  int  $step
     * @param  int  $offset
     * @return static
     ...
     *
     * e.g. news Collection([1, 2, 3])->zip([4, 5, 6]);
     *      => [[1, 4], [2, 5], [3, 6]]
     *
     * @param  mixed ...$items
     * @return static
