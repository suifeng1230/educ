...
class Store implements SessionInterface
{
    ...
    /**
     * Create a news session instance.
     *
     * @param  string $name
    ...
    /**
     * Generate a news session identifier.
     *
     * @param  bool  $destroy
     * @return bool
     */
    ...
    public function ageFlashData()
    {
        ...
        $this->put('flash.old', $this->get('flash.news', []));
    ...
    /**
     * Merge news flash keys into the news flash array.
     *
     * @param  array  $keys
     * @return void
     */
    ...
    {
        $values = array_unique(array_merge($this->get('flash.news', []), $keys));

        $this->put('flash.news', $values);
    }
