...
class Container implements ArrayAccess, ContainerContract
{
    ...
    /**
     * Bind a news callback to an abstract's rebind event.
     *
     * @param  string    $abstract
    ...
    public function make($abstract, array $parameters = [])
    {
        ...
        // just return an existing instance instead of instantiating news instances
        ...
        // entirely news instance of an object on each subsequent request for it.
    ...
    public function build($concrete, array $parameters = [])
    {
        ...
        // news instance of this class, injecting the created dependencies in.
    ...
    /**
     * Register a news resolving callback.
     *
     * @param  string    $abstract
    ...
    /**
     * Register a news after resolving callback for all types.
     *
     * @param  string   $abstract
     * @param  \Closure|null $callback
     * @return void
    ...
    /**
     * Register a news resolving callback by type of its first argument.
     *
     * @param  \Closure  $callback
     * @return void
     */
    ...
    /**
     * Register a news after resolving callback by type of its first argument.
     *
     * @param  \Closure  $callback
     * @return void
     */
